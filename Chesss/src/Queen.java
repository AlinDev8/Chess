...
public class Queen extends Piece{
    ...
    /**
     * Создает список массивов, содержащий все исходные ходы, доступные ферзю на данной доске
     * @param pieces разбивает игровую доску на фигуры*
     * @return список массивов, содержащий все координаты, полученные из класса ходов.
     * (все диагонали, все вертикали и все горизонтали)
     */
