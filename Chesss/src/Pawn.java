...
public class Pawn extends Piece {
    ...
    /**
     * Определяет, может ли черная пешка продвигаться вперед
     * @param coordinate - координата, которую нужно продвигать до
     * @return значение true, если пешка черная и ее ранг равен первому рангу (1)
     */
    ...
    /**
     * Определяет, может ли белая пешка продвигаться вперед
     * @param coordinate - координата, на которую нужно продвигаться
     * @return  значение true, если пешка белая и ее ранг является последним (8).
     */
    ...
    /**
     * Создает массив данных, содержащий все исходные ходы, доступные пешке на данной доске
     * @param  pieces игровую доску на фигуры
     * @return массив данных, содержащий все координаты, доступные пешке, на основе:
     * может ли он переместиться на 0,1 или 2 клетки вперед (используя pawnForward)
     * может ли он совершать захваты по диагонали? (используя canEatLeftDig и canEatRightDig)
     * может ли он совершать захваты в проходе? (используя enPassant)
     */
